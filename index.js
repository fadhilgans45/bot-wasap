...
//
const BotName = 'FADHIL GANS'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/_fadhilmuhammad45'; // Nama Instagramlu cok
const whatsapplu = '18623216664'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @_Fadhilmuhammad45`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @_Fadhilmuhammad45`)
})
